...
<head>
    <meta charset="UTF-8">
    <title>Rapport Mensuel - Golden Prestige</title>
    <style>
...
<body onload="window.print();">
    ...
    <div class="header">
        <div class="logo">Bémar hôtel Prestige</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>Salles de Conférence & Garden Party</td>
